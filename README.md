...
**Version 31.0.0 — The Consulate. Built, tested, publish-ready — not proposed.**
...
python -m pytest            # 384 proofs incl. the 9-scenario chaos storm, ~100 seconds
...
```
src/aeos/            # 56 modules: kernel (v1) + platform (v2–v31)
