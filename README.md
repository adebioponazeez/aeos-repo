...
**Version 39.3.0 — The Field Test. Resilient beyond one sandbox — proven, not presumed.**
...
discovery). v2–v39 ship the platform around it. **515 tests. Zero
...
python -m pytest            # 515 proofs incl. the 9-scenario chaos storm, ~120 seconds
